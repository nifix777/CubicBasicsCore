...
namespace Cubic.Core.Collections
{
  ...
  public class PropertyBag
  {
    ...
    /// The properties.
    /// </value>
    public IEnumerable<string> Keys { get { return _properties.Keys; } }
    ...
    public void AddRange(IEnumerable<KeyValuePair<string, string>> newProperties)
    {
    ...
    public void AddRange(IEnumerable<DictionaryEntry> newProperties)
    {
      if (newProperties == null)
      {
        throw new ArgumentNullException("newProperties");
      ...
      foreach (var property in newProperties)
      {
        Add(property.Key.ToString(), property.Value.ToString());
      }
    }

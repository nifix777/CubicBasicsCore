...
namespace Cubic.Core.Collections
{
  ...
  public class OrderedDictionary<TKey, TValue> : IDictionary<TKey , TValue>, IList<KeyValuePair<TKey , TValue>>
  {
    ...
    /// </summary>
    internal System.Collections.Generic.Dictionary<TKey , TValue> internalDictionary;
    ...
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>();
      this.internalList = new List<KeyValuePair<TKey , TValue>>();
    }

    public OrderedDictionary( IDictionary<TKey , TValue> dictionary )
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>( dictionary );
      this.internalList = new List<KeyValuePair<TKey , TValue>>( dictionary );
    }

    public OrderedDictionary( IEqualityComparer<TKey> comparer )
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>( comparer );
      this.internalList = new List<KeyValuePair<TKey , TValue>>();
    }

    public OrderedDictionary( Int32 capacity )
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>( capacity );
    ...
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>( values , comparer );
    ...
    {
      this.internalDictionary = new System.Collections.Generic.Dictionary<TKey , TValue>( capacity , comparer );
      this.internalList = new List<KeyValuePair<TKey , TValue>>( capacity );
    }
